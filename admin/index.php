      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="#"><img src="../images/male.jpg" width="100" height="100" alt="not found"/></a></li>
		...
		@$page=  $_GET['page'];
          ...
          <div class="row placeholders">
            ...
            <div class="col-xs-6 col-sm-3 placeholder">
              <img src="https://upload.wikimedia.org/wikipedia/en/6/6d/SRTMUN_Logo_Official_Color_-PNG.png" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
              <h4>SRTMUN</h4>
