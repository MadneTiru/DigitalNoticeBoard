...
$query="update user set name='$n',mobile='$mob',gender='$gen',class='$class',dob='$dob' where email='".$_SESSION['user']."'";

//$query="insert into user values('','$n','$e','$pass','$mob','$gen','$class','$imageName','$dob',now())";
...
<h2 align="center"><B>UPDATE YOUR PROFILE</B></h2>
	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
        	<td>Select class:</td>
        	<td><select class="form-control" name="class" required>
          <option>-->select your class<--</option>
          <option>MCA. First Year</option>
          <option>MCA. Second Year</option>
          <option>M.sc CS. First Year</option>
          <option>M.sc CS. Second Year</option>
          <option>M.sc CA. First Year</option>
          <option>M.sc CA. Second Year</option>
        </select>
			</td>
      </tr>
